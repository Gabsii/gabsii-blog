...
export default function Footer() {
  return (
    ...
    >
      <section className='max-w-1200 mx-auto w-full grid grid-cols-4 gap-[1px] pt-10 pb-24'>

        <div
          className="space-y-2 col-span-1 flex flex-col"
        >
        ...
        <div className='mt-14'>© LUKAS GABSI 2024</div>
      </section>
    </footer >
  )
}
