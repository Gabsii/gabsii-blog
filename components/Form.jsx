  ...
  render() {
    return (
      ...
      >
        ...
        <input
          type="text"
          onChange={this.handleMailInput.bind(this)}
          required={true}
          placeholder="E-Mail (your E-Mail will not be displayed)"
          name="mail"
          id="mail"
          className={`${styles.input}`}
        />
        ...
        {/* Displays an error if uploading the comment did go wrong */}
        <div
          id="error"
          style={{
            display: 'none',
        ...
        >
          Error: something went wrong. Please try again later again or contact
          me!
        </div>
      </form>
    )
